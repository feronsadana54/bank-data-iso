                    ...
                    <div class="col-sm-6">
                        ...
                        <?php foreach ($user_kat as $u) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul_file" name="judul_file" value="<?= $triwulan['judul_file']; ?>" readonly>
                            ...
                            <div class="form-group">
                                <label for="bussinnes_area">Bisnis Area</label>
                                <input type="text" class="form-control" id="bussinnes_area" name="bussinnes_area" placeholder="Masukkan kode bisnis area">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tahun" id="tahun" class="form-control">
                                    <option value="<?= $triwulan['tahun']; ?>">Data Saat ini tahun : <?= $triwulan['tahun']; ?></option>
