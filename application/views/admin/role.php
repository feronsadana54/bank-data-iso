            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="col-lg-12">
                    <h3 mb-4 text-gray-800><i class="fa fa-fw fa-user-tie"></i><?= $title; ?></h3>
                </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($role as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r['role']; ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/roleaccess/') . $r['id']; ?>"></span><span class="badge badge-warning">Access</span></a>
                        ...
                        <form action="<?= base_url('admin/role'); ?>" method="post">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Judul Role</label>
